...
In OpenxavaTest-labels_en.properties:
OpenxavaTest=My application
OpenxavaTest[description]=My application does this and that

In OpenxavaTest-messages_en.properties:
